...
class StudentProfileView {
  ...
  StudentProfileView({
    ...
    required this.fatherCareer,
    required this.fatherPlaceOfResidence,
    required this.fatherTieNumber,
    required this.fatherTiePlace,
    required this.fatherPlaceOfBirth,
    required this.fatherReligion,
    required this.fatherCivilRegisterSecretary,
    required this.educationalStatus,
    required this.fatherPhoneNumber,
    required this.fatherPermenantAddress,
    required this.motherName,
    required this.motherLastName,
    required this.motherFatherName,
    required this.motherMotherName,
    required this.motherDoesLiveWithHasband,
    required this.motherCareer,
    required this.motherTieNumber,
    required this.motherTiePlace,
    required this.motherPlaceOfBirth,
    required this.motherDateOfBirth,
    required this.motherReligion,
    required this.motherEducationalStatus,
